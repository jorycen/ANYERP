...
const {
  getMenus, reorderMenus, getRoles, getUserDistributors, createRole, updateRole, deleteRole, getRoleMenus, assignMenus,
...
router.post('/menus/reorder', requireRole('admin', 'boss'), reorderMenus);
