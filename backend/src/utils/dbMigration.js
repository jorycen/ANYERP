...
async function runMigrations() {
  ...
  try {
    ...
    await checkAndAddColumn('T_PURCHASE_REQUEST', 'STATUS', 'VARCHAR(32) DEFAULT "pending" COMMENT "draft/pending/approved/rejected/revoked"');
    ...
    await checkAndMakeColumnNullable('T_PURCHASE_REQUEST', 'SUPPLIER_ID', 'VARCHAR(32)');
