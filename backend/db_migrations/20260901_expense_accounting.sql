...
ALTER TABLE T_EXPENSE
  ...
  ADD COLUMN ATTRIBUTION_TYPE VARCHAR(32) NOT NULL DEFAULT 'STORE' COMMENT '费用归属：个人/门店/产品端/公司/返利' AFTER AFFECTS_STORE_PROFIT,
  ADD COLUMN ATTRIBUTION_METHOD VARCHAR(16) NOT NULL DEFAULT 'AVERAGE' COMMENT '费用分摊方式：平均或手工金额' AFTER ATTRIBUTION_TYPE,
  ADD COLUMN ATTRIBUTION_DETAILS_JSON LONGTEXT COMMENT '费用归属及分摊明细JSON' AFTER ATTRIBUTION_METHOD,
  ADD COLUMN REBATE_SETTLEMENT_ID VARCHAR(32) COMMENT '返利归属对应待核销单ID' AFTER ATTRIBUTION_DETAILS_JSON;
