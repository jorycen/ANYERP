...
test('inventory summary export keeps only in-stock target categories and sorts them', () => {
  ...
  assert.deepEqual(rows, [
    { 产品名称: '笔记本', PN: 'PN-N', 定价: 10, 库存: 5, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品名称: '平板', PN: 'PN-T', 定价: 20, 库存: 1, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品名称: '服务商有货手机', PN: 'PN-S', 定价: 60, 库存: 0, 佳华库存: '少量', 汇一库存: '8', 近7天销量: 0, 近30天销量: 0 },
    { 产品名称: '手机', PN: 'PN-P', 定价: 30, 库存: 2, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品名称: '台机', PN: 'PN-D', 定价: 40, 库存: 3, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品名称: '配件', PN: 'PN-A', 定价: 50, 库存: 4, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 }
  ]);
});
