...
test('inventory summary export keeps the category-management order supplied by inventory query', () => {
  ...
  assert.deepEqual(rows, [
    { 产品类型: '电子产品/笔记本', 产品名称: '笔记本', PN: 'PN-N', 定价: 10, 库存: 5, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品类型: '平板', 产品名称: '平板', PN: 'PN-T', 定价: 20, 库存: 1, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品类型: '手机', 产品名称: '服务商有货手机', PN: 'PN-S', 定价: 60, 库存: 0, 佳华库存: '少量', 汇一库存: '8', 近7天销量: 0, 近30天销量: 0 },
    { 产品类型: '手机', 产品名称: '手机', PN: 'PN-P', 定价: 30, 库存: 2, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品类型: '台式机', 产品名称: '台机', PN: 'PN-D', 定价: 40, 库存: 3, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 },
    { 产品类型: '配件', 产品名称: '配件', PN: 'PN-A', 定价: 50, 库存: 4, 佳华库存: '-', 汇一库存: '-', 近7天销量: 0, 近30天销量: 0 }
  ]);
});
...
test('库存简表导出近7天和近30天销量', () => {
  const [row] = _test.buildInventorySummaryExportRows([
    { product_id: 'sales', category: '手机', product_name: '测试手机', normal_qty: 1, sales_7_qty: '3', sales_30_qty: '12' }
  ]);
  assert.equal(row.近7天销量, 3);
  assert.equal(row.近30天销量, 12);
});
