...
CREATE TABLE T_PRODUCT_PRICE (
  ...
  STANDARD_PRICE DECIMAL(12,2) DEFAULT 0 COMMENT '定价',
...
CREATE TABLE T_ORDER_GROSS_PROFIT (
  ...
  SETTLEMENT_COST_AMOUNT DECIMAL(12,2) NOT NULL DEFAULT 0 COMMENT '销售结算成本',
  ...
  SETTLEMENT_COST_DETAILS JSON COMMENT '商品结算成本明细',
